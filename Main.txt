...
local Window = Libary:MakeWindow({
    ...
    SubTitle = "by: Linux STUDIOS",
    LoadText = "Carregando Linux hub",
...
InfoTab:AddParagraph({ "Owner / Developer:", "Vs⁷⁷⁷ GL" })
InfoTab:AddParagraph({ "Colaborações:", ", , Bah, Nick, Anthex" })
InfoTab:AddParagraph({ "Você está usando:", "Iinux hub " })
